...
\begin{frame}{Connectedness in Clique-Like Algorithms}
    \begin{itemize}
        ...
        \item On the other hand, we \emph{can} use restricted branching, if we give more information
            ...
            \begin{itemize}
                \item Integrating this with the bound and ordering heuristic used in modern clique
                    algorithms is horribly technical and was far harder than we make it look in the
                    paper (honest!).
            \end{itemize}
    \end{itemize}
\end{frame}
