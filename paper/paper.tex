...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}[scale=0.33]%{{{
        ...
        \begin{scope}[xshift=13cm]
            ...
            \node [anchor=base, yshift=-2.2cm] at ($(Ma)!0.5!(M2)$) {
                \stepcounter{stepcounter}\roman{stepcounter}) Try $a \mapsto 1$ };
        \end{scope}
        ...
        \begin{scope}[xshift=26cm]
            ...
            \node [anchor=base, yshift=-2.2cm] at ($(Ma)!0.5!(M2)$) {
                \stepcounter{stepcounter}\roman{stepcounter}) Try $b \mapsto 2$ };
        \end{scope}
        ...
        \begin{scope}[yshift=-9cm]
            ...
            \node [anchor=base, yshift=-2.2cm] at ($(Ma)!0.5!(M2)$) {
                \stepcounter{stepcounter}\roman{stepcounter}) Try $d \mapsto 4$ };
        \end{scope}
