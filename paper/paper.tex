...
\begin{figure}[p]
    ...
    clique approach compared to the best constraint programming approach: the colour at a point indicates the number of
...
\begin{figure}[p]
    ...
    \caption{Clique versus constraint programming, connected, undirected, 33\% labelled, up to 100 vertices. On the top,
        ...
        bottom, the best clique approach compared to the best constraint programming approach: the colour at a point
...
\begin{figure}[p]
    ...
    the best clique approach compared to the best constraint programming approach: the colour at a point indicates the
