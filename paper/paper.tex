...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}[scale=0.33]%{{{
        ...
        \begin{scope}[xshift=15cm, yshift=-1cm]
            ...
            \node (La2) [above = 0 of Ma2, font=\small] { \vphantom{0}2 };
            \node (La3) [above = 0 of Ma3, font=\small] { \vphantom{0}3 };
            \node (La4) [above = 0 of Ma4, font=\small] { \vphantom{0}4 };
            ...
            \node (Lc1) [below = 0 of Mc1, font=\small] { \vphantom{0}1 };
            \node (Lc2) [below = 0 of Mc2, font=\small] { \vphantom{0}2 };
            \node (Lc3) [below = 0 of Mc3, font=\small] { \vphantom{0}3 };
    ...
    \caption{A maximum common induced subgraph between the two graphs on the left has three
        ...
        highlighted clique of size three shows the same solution. In practice the isolated matching
        nodes (representing assignments between incompatible vertices, due to the presence or
    absence of loops) would be omitted.}\label{figure:association}
\end{figure}
...
\nl \Begin{
    ...
    $\hspace*{2em}\FuncSty{colour}(G, \mathit{remaining} \setminus \mathit{connected}),$ \;
    $\hspace*{2em}\FuncSty{colour}(G, \mathit{remaining} \cap \mathit{connected}))$ \;
