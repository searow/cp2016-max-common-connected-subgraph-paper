...
loops; their extension to richer graphs is discussed in \cref{extension}.  (Other approaches have
been tried, mixed integer programming \cite{DBLP:journals/anor/PivaS12} and heuristics
...
\begin{figure}[tb]
    ...
    \caption{A maximum common induced subgraph between the two graphs on the left has three
        ...
        (representing assignments between incompatible vertices) would be omitted.}\label{figure:association}
\end{figure}
