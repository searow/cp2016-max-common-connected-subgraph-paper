...
plot \
    "unconnected-plain.data" u (sprintf("%.1e",$2 * 1000)+0):($2 * 1000 >= 3600e3 ? 1e-10 : 1) smooth cumulative ti "MAC" lc rgb '#7a0177' dt 2, \
    "unconnected-plain.data" u (sprintf("%.1e",$3)+0):($3 >= 3600e3 ? 1e-10 : 1) smooth cumulative ti "Clique" lc rgb '#4393C3'
